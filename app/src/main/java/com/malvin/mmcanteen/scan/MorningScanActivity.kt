            ...
            result.success {
                try {
                    ...
                    when(respondData?.status){
                        1 -> {
                            val nisText = resources.getString(R.string.scan_success_morning, nis)
                            nis_number?.visibility = View.VISIBLE
                            scan_again?.visibility = View.VISIBLE
                        ...
                        3 -> {
                            val nisText = resources.getString(R.string.scan_failed_status_morning, nis)
                            nis_number?.visibility = View.VISIBLE
                            scan_again?.visibility = View.VISIBLE
                            nis_number?.text = nisText
                        }
                        0 -> {
                            nis_number?.visibility = View.VISIBLE
                            scan_again?.visibility = View.VISIBLE
                            nis_number?.text = resources.getString(R.string.scan_already_morning, nis)
                        }
                        else -> {
